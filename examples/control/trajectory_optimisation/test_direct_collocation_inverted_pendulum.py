...
optimizer = DirectCollocation(env, horizon=40, path_cost_w=1.0, dynamics_cost_w=1e9)
...
success, state_path, action_path, cost = optimizer.run(start, goal, initial_state_path, initial_action_path)

...
class RRTStar(object):
    ...
    def extend(self, v_goal, expand_func, delta, distance_func, check_link, radius=2):
        ...
        @param expand_func, function(v1, v2, delta) -> v_new, a function that expand tree from v1 to v2 by delta,
            return resulting v_new
        ...
        @param check_link, function(v1, v2) -> can_link, dist, a function that checks whether v1 and v2 can be
            linked by a simple path.
        ...
        if v_new is not None:
            ...
            if len(neighbours) > 0:
                ...
                best_neighbour, best_g = (
                    nearest_neighbour,
                    distance_func(nearest_neighbour, v_new) + self.g[nearest_neighbour],
                )

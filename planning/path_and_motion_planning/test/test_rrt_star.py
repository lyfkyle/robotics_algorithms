...
from planning.path_and_motion_planning.rrt_star import RRTStarConnect
...
# initialize planner
my_path_planner = RRTStarConnect(number_of_samples = 1000) # 1000 samples out of total 2500 vertex.

# run path planner
start_time = time.time()
res, shortest_path, shortest_path_len = my_path_planner.run(source, goal, sample_vertex, expand, 1, compute_distance, check_link)
end_time = time.time()
